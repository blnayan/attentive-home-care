...
export default function DocusignExamplePage() {
  ...
  const [signatureType, setSignatureType] = useState<"signature" | "initial">(
    "signature"
  );
                  ...
                  <div className="p-6">
                    <div className="text-center mb-8">
                      ...
                      <p className="text-gray-500 text-sm">
                        Document ID: AHC-2023-0458
                      </p>
                    </div>

                    <div className="space-y-6 text-sm">
                      <p>
                        This Care Services Agreement (the &quot;Agreement&quot;)
                        is entered into as of the date of signing by and between
                        Attentive Home Care, Inc. (&quot;Provider&quot;) and the
                        undersigned client or client&apos;s authorized
                        representative (&quot;Client&quot;).
                      </p>

                      <h4 className="font-semibold">1. SERVICES</h4>
                      <p>
                        Provider agrees to provide non-medical home care
                        services to Client as outlined in the Care Plan attached
                        to this Agreement. Services may include companionship,
                        homemaking, personal care, and respite care as specified
                        in the Care Plan.
                      </p>
                      ...
                      <p>
                        ...
                        shall continue until terminated by either party as
                        provided herein.
                      </p>

                      <h4 className="font-semibold">3. FEES AND PAYMENT</h4>
                      <p>
                        Client agrees to pay Provider for services at the rates
                        specified in the attached Rate Schedule. Payment is due
                        upon receipt of invoice. Provider reserves the right to
                        modify the Rate Schedule with 30 days&apos; written
                        notice to Client.
                      </p>

                      <h4 className="font-semibold">4. CANCELLATION POLICY</h4>
                      <p>
                        Client may cancel scheduled services with at least 24
                        hours&apos; notice without charge. Cancellations with
                        less than 24 hours&apos; notice may result in a
                        cancellation fee equal to 50% of the scheduled service
                        fee.
                      </p>

                      <div className="border-t pt-4 mt-8">
                        <p className="italic text-gray-600">
                          Please review the entire document carefully before
                ...
                <div className="bg-white border rounded-lg shadow-sm overflow-hidden mb-6">
                  <div className="p-4 bg-gray-100 border-b">
                    <h3 className="font-medium">
                      Care Services Agreement - Signature Page
                    </h3>
                  </div>
                  <div className="p-6">
                    <div className="space-y-6 text-sm">
                      ...
                      <p>
                        ...
                        conditions of this Agreement, including all attachments
                      ...
                      <div className="mt-8 space-y-6">
                        <div className="border rounded p-4 relative">
                          ...
                          {signatureAdded ? (
                            <div className="h-16 flex items-center">
                              <div className="italic text-blue-600 text-xl font-signature">
                                Jane Smith
                              </div>
                            </div>
                          ) : (
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div className="border rounded p-4 relative">
                            ...
                            {initialAdded ? (
                              <div className="h-10 flex items-center">
                                <div className="italic text-blue-600 text-lg font-signature">
                                  JS
                                </div>
                              </div>
                            ) : (
                    ...
                    <div className="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-blue-600 text-sm mt-1">
                          Please review your signature and information before
                    ...
                    <div className="border-t pt-6">
                      <div className="flex items-start space-x-2 mb-6">
                        ...
                        <div className="grid gap-1.5 leading-none">
                          ...
                          >
                            I agree to the Electronic Records and Signature
                            Disclosure
                          </Label>
                          <p className="text-sm text-muted-foreground">
                            By checking this box, I consent to the electronic
                            delivery of documents and to electronically sign
                            this document.
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="p-6">
                    <Tabs defaultValue="draw" className="w-full">
                      <TabsList className="grid w-full grid-cols-3 mb-4">
                        <TabsTrigger
                          value="draw"
                          onClick={() => setSignatureStyle("drawn")}
                        >
                          Draw
                        </TabsTrigger>
                        <TabsTrigger
                        ...
                        <TabsTrigger
                          value="upload"
                          onClick={() => setSignatureStyle("uploaded")}
                        >
                          Upload
                        </TabsTrigger>
                      </TabsList>
          ...
          <div className="container mx-auto px-4 py-12">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-gray-600 mb-8">
                Your Care Services Agreement has been signed and completed. A
                copy has been emailed to you for your records.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-xs text-gray-500">
              Powered by <span className="font-medium">DocuSign</span> • Secure
