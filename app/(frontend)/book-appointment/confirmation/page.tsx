  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-12 md:py-24">
        <Link
          href="/"
          className="inline-flex items-center text-sm font-medium text-gray-600 hover:text-green-700 mb-6"
        >
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="bg-white rounded-lg shadow-sm border p-8 mb-8">
            <p className="text-gray-600 mb-6">
              Thank you for scheduling a consultation with Attentive Home Care.
              We have received your appointment request and a member of our care
            ...
            <div className="text-left bg-gray-50 p-6 rounded-lg mb-6">
              ...
              <ol className="space-y-3 list-decimal list-inside text-gray-600">
                ...
                <li>
                  We&apos;ll prepare for your consultation based on your needs
                </li>
              </ol>
            </div>

            <p className="text-sm text-gray-500">
              If you need immediate assistance or would like to speak with
              someone sooner, please call us at{" "}
